...
namespace Procurement_Inventory_System
{
    public class DatabaseClass
    {
        ...
        public void ConnectDatabase() // call this first every time we perform CRUD
        {
            ...
            connectionString = "Data Source=LAPTOP-SNHBLSGH\\SQLEXPRESS01;Initial Catalog=Procurement_Inventory_System;Integrated Security=True";
        ...
        public void OpenConnection()   // call this to close connection
        {
            sqlConnection.Open();
        }
